...
if(isset($_POST['submit'])){
		...
		if(array_filter($errors)){
			...
			$addStudent = new Test();
			$addStudent -> setStudentsStmt ($_POST['first_name'], $_POST['last_name'], $_POST['username'], $_POST['email']);
            echo '<div class="alert alert-primary" role="alert">' . 'Student has been added' . '</div>';
        }
}
?>
